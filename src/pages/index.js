            ...
            <div className="col-span-4">
                <Link className="project-thumb text-gray-600 transition duration-300 ease-in-out" to="/">
                  <div className="w-full h-56 mb-6 rounded-3xl overflow-hidden" alt="Illustration project">
                    ...
                    <h3 className="hover-underline inline ml-8 text-2xl font-rubik text-gray-700">Illustrations</h3>
                </Link>  
            </div>
            <div className="col-span-4">
                <Link className="project-thumb text-gray-600 transition duration-300 ease-in-out" to="/">
                  <div className="w-full h-56 mb-6 rounded-3xl overflow-hidden" alt="Illustration project">
                    ...
                    <h3 className="hover-underline inline ml-8 text-2xl font-rubik text-gray-700">Inohub</h3>
                </Link>  
            </div>
            <div className="col-span-4">
                <Link className="project-thumb text-gray-600 transition duration-300 ease-in-out" to="/">
                  <div className="w-full h-56 mb-6 rounded-3xl overflow-hidden" alt="Illustration project">
                    ...
                    <h3 className="hover-underline inline ml-8 text-2xl font-rubik text-gray-700">Transparência Brasil</h3>
                </Link>  
            </div>
          </div>
        </div>
