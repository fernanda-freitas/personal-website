    ...
    return (
        <>
          <div className="w-10/12 mx-auto mb-28 mt-32">
            ...
            <h2 className="max-w-5xl mt-3 text-lg md:text-5xl font-rubik leading-tight text-gray-600">
              <a className="font-rubik text-purple-600" href="https://applepie-1976.herokuapp.com/" target="_blank">Applepie</a> is a marketplace app for buying and selling iPods. It was developed as part of a bootcamp using Rails.</h2>
            <div className="mt-6">
