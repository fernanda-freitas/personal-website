    ...
    return (
        <>
          <div className="w-10/12 mx-auto mb-28 mt-32">
            ...
            <h2 className="max-w-5xl mt-3 text-5xl font-rubik leading-tight text-gray-600">Frontend development and some part of the User Interface for Artsol, a non profit Brazilian organization dedicated to extra curricular child care.</h2>
            <div className="mt-6">
