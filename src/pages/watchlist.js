    ...
    return (
        <>
          <div className="w-10/12 mx-auto mb-28 mt-32">
            ...
            <h2 className="max-w-5xl mt-3 text-lg md:text-5xl font-rubik leading-tight text-gray-600">Ui for a Rails app to create movie lists and append new movies to it. Based on CRUD actions it makes use of a join table in order to create bookmarks.</h2>
            <div className="mt-6">
