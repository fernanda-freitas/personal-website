...
export default function medicaPage() {
    ...
    <>
        ...
        <img className="w-10/12 h-auto object-contain mx-auto" src={Medica06} alt="Alterar alt" />
        <img className="w-10/12 h-auto mt-16 object-contain mx-auto" src={Medica07} alt="Alterar alt" />
        <div className="w-8/12 mx-auto mb-40 mt-28 col-span-12 grid grid-cols-12 gap-8">
            <h1 className="col-span-12 text-4xl font-rubik font-semibold text-gray-700 mt-16">Wireframe</h1>
        </div>  
        <img className="w-10/12 h-auto mt-16 object-contain mx-auto" src={Medica08} alt="Alterar alt" />
        <img className="w-10/12 h-auto mt-16 object-contain mx-auto" src={Medica09} alt="Alterar alt" />
        <div className="w-8/12 mx-auto mb-40 mt-28 col-span-12 grid grid-cols-12 gap-8">
            <h1 className="col-span-12 text-4xl font-rubik font-semibold text-gray-700 mt-16">Design solution</h1>
        </div>  
        <img className="w-10/12 h-auto mt-16 object-contain mx-auto" src={Medica10} alt="Alterar alt" />
        <img className="w-10/12 h-auto mt-16 object-contain mx-auto" src={Medica11} alt="Alterar alt" />
        <img className="w-10/12 h-auto mt-16 object-contain mx-auto" src={Medica12} alt="Alterar alt" />
        <img className="w-10/12 h-auto mt-16 object-contain mx-auto" src={Medica13} alt="Alterar alt" />
        <img className="w-10/12 h-auto mt-16 object-contain mx-auto" src={Medica14} alt="Alterar alt" />
        <img className="w-10/12 h-auto mt-16 object-contain mx-auto" src={Medica15} alt="Alterar alt" />
    </ >
    )
};
