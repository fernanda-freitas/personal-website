...
import Inohub01 from "../assets/images/inohub01.jpg"
import Inohub02 from "../assets/images/inohub02.gif"
import Inohub03 from "../assets/images/inohub03.gif"
import Inohub04 from "../assets/images/inohub04.jpg"
import Inohub05 from "../assets/images/inohub05.jpg"
import Inohub06 from "../assets/images/inohub06.jpg"
import Inohub07 from "../assets/images/inohub07.jpg"
import Inohub08 from "../assets/images/inohub08.jpg"
import Inohub09 from "../assets/images/inohub09.jpg"
import Inohub10 from "../assets/images/inohub10.jpg"
import Inohub11 from "../assets/images/inohub11.jpg"
import Inohub12 from "../assets/images/inohub12.jpg"
import Inohub13 from "../assets/images/inohub13.jpg"
  ...
  return  (
    <>
      <div className="w-9/12 mx-auto mb-28 mt-32">
          ...
          <h2 className="max-w-5xl mt-3 text-5xl font-rubik leading-tight text-gray-500">Branding project for the National Center for Creative Economy, based in Sao Paulo - Brazil</h2>
          <div className="mt-6">
        ...
        <img className="w-full h-172 object-cover" src={Inohub02} alt="Alterar alt" />
        <div className="w-9/12 mx-auto my-40 col-span-12 grid grid-cols-12 gap-8">
        ...
        <img className="w-full h-auto object-cover" src={Inohub05} alt="Alterar alt" />
        <img className="w-9/12 mx-auto h-auto mt-40 object-cover" src={Inohub03} alt="Alterar alt" />
        <img className="w-full h-auto mt-40 object-cover" src={Inohub08} alt="Alterar alt" />
        <img className="w-9/12 mx-auto h-auto mt-20 object-cover" src={Inohub09} alt="Alterar alt" />
        <img className="w-9/12 mx-auto h-auto mt-20 object-cover" src={Inohub07} alt="Alterar alt" />
        <img className="w-9/12 mx-auto h-auto mt-20 object-cover" src={Inohub06} alt="Alterar alt" />
        <img className="w-9/12 mx-auto h-auto mt-20 object-cover" src={Inohub10} alt="Alterar alt" />
        <img className="w-full h-auto object-cover" src={Inohub11} alt="Alterar alt" />
        <div className="grid grid-cols-12">
          <img className="col-span-12 md:col-span-6 h-136 object-cover" src={Inohub12} alt="Alterar alt" />
          <img className="col-span-12 md:col-span-6 h-136 object-cover" src={Inohub13} alt="Alterar alt" />
        </div>
    </ >
  )
}